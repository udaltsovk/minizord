...
use super::{CreateKnows, Knows, KnowsUpdate};
use crate::{
...
implementation! {
    KnowsRepository {
        ...
        save(&self, new: CreateKnows) -> Knows {
            self.db.0
        ...
        update_by_in_and_out(&self, r#in: UserId, out: TechnologyId, update: KnowsUpdate) -> Option<Knows> {
            self.db.0
